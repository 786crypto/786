...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-net");
...
static const char *strDNSSeed[][2] = {
	{"185.144.158.117", "185.144.158.117"},
	{"185.144.156.214", "185.144.156.214"}
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SevenEightSixCrypto is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("SevenEightSixCrypto-start");
